...
$root.apiserver = (function() {
    ...
    apiserver.CreateResourceRequest = (function() {
        ...
        CreateResourceRequest.encode = function encode(message, writer) {
            ...
            if (message.dataflow != null && Object.hasOwnProperty.call(message, "dataflow"))
                $root.apiserver.CreateDataflowOptions.encode(message.dataflow, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
    ...
    apiserver.CreateResourceResponse = (function() {
         ...
         * @property {string|null} [resourceId] CreateResourceResponse resourceId
         ...
         * @instance
         */
        CreateResourceResponse.prototype.resourceId = "";
         ...
         * @instance
         */
        CreateResourceResponse.prototype.errorMsg = null;

        // OneOf field names bound to virtual getters and setters
        var $oneOfFields;

        /**
         * CreateResourceResponse _errorMsg.
         * @member {"errorMsg"|undefined} _errorMsg
         * @memberof apiserver.CreateResourceResponse
         * @instance
         */
        Object.defineProperty(CreateResourceResponse.prototype, "_errorMsg", {
    ...
    apiserver.Resource = (function() {
         ...
         * @memberof apiserver
         * @interface IResource
         * @property {string|null} [resourceId] Resource resourceId
    ...
    apiserver.GetResourceRequest = (function() {
         ...
         * @property {string|null} [resourceId] GetResourceRequest resourceId
         */
         ...
         * @instance
         */
        GetResourceRequest.prototype.resourceId = "";
    ...
    apiserver.DeleteResourceRequest = (function() {
         ...
         * @property {string|null} [resourceId] DeleteResourceRequest resourceId
         */
         ...
         * @instance
         */
        DeleteResourceRequest.prototype.resourceId = "";
